...
class SpeechletResponse(outputSpeech: OutputSpeech = null, card: Card = null, reprompt: Reprompt = null, shouldEndSession: Boolean = true) extends speechlet.SpeechletResponse {
